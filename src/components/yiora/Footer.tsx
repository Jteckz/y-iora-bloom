...
export function Footer() {
  ...
  return (
    <Section
      ...
      divider="line"
      dividerPosition="top"
      className="isolate pt-12 pb-8 sm:pt-16 sm:pb-8"
    >
      <div
        aria-hidden
        className="absolute inset-0 bg-gradient-to-b from-background/0 via-transparent to-linen/60"
      />
      ...
      <Reveal className="mx-auto max-w-2xl text-center">
        ...
        >
          ...
          <p className="text-xs text-cocoa/40">
            No spam. Unsubscribe anytime. We write like humans.
          </p>
        </form>
      </Reveal>
      ...
      <div className="mt-8 flex flex-col items-center gap-4 text-center text-sm text-cocoa/60 sm:flex-row sm:justify-between sm:text-left">
        <p className="font-display text-[0.72rem] tracking-[0.16em] font-semibold text-cocoa">
          Y&apos;IORA &mdash; SINCE 2026 · TANZANIA
        </p>
